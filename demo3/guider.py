...
def main():
    ...
    robot = TriOrbController(device_path, logger, distance_offset_correction=0.02, angle_offset_correction=0.10)
    ...
    # robot.move(x_vel=0, y_vel=-0.2, z_vel=0, desired_distance=2.4, axis="y")
    robot.get_pose()
