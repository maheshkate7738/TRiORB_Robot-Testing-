...
def main():
    ...
    for _ in range(1):
        ...
        robot_controller.move(x_vel=0, y_vel=-0.2, z_vel=0, desired_distance=0.9, axis='y')
        robot_controller.lift(1)  # Lift up
        #robot_controller.turn(desired_angle=3.14, direction='cw')

        robot_controller.move(x_vel=0, y_vel=0.2, z_vel=0, desired_distance=2.5, axis='y')
        #robot_controller.turn(desired_angle=3.14, direction='cw')
        #robot_controller.turn(desired_angle=3.14, direction='cw')
        robot_controller.lift(-1)  # Lift down
        robot_controller.move(x_vel=0, y_vel=-0.2, z_vel=0, desired_distance=1.6, axis='y')
